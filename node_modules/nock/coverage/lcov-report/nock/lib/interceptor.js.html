...
<html lang="en">
<head>
    <title>Code coverage report for nock/lib/interceptor.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">nock/lib/interceptor.js</span></h1>
    <h2>
        Statements: <span class="metric">92.37% <small>(218 / 236)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">87.57% <small>(155 / 177)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.31% <small>(24 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.37% <small>(218 / 236)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187; interceptor.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            this.options[opt] = this.scope.scopeOptions[opt];</span>
        }
    }
&nbsp;
...
Interceptor.prototype.delay = function delay(opts) {
    ...
    if (_.isNumber(opts)) {
        headDelay = opts;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isObject(opts)) {
