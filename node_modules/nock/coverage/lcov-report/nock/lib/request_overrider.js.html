...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">86.9% <small>(146 / 168)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.1% <small>(27 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93% <small>(239 / 257)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">486</span>
<span class="cline-any cline-yes">3652</span>
<span class="cline-any cline-yes">3652</span>
...
&nbsp;
            ...
            typeof responseBody[0] == 'number')
        {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (! response.headers) <span class="cstat-no" title="statement not covered" >response.headers = {};</span>
          _.assign(response.headers, responseBody[2] || {});
          debug('response.headers after: %j', response.headers);
          responseBody = responseBody[1];
&nbsp;
          response.rawHeaders = response.rawHeaders || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
