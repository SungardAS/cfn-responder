...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">92.61% <small>(163 / 176)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">77.5% <small>(62 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">89.19% <small>(33 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.57% <small>(162 / 175)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
function Scope(basePath, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Scope)) {
...
Scope.prototype.remove = function remove(key, interceptor) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._persist) {
...
Scope.prototype.filteringPath = function filteringPath() {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.transformPathFunction) {
...
Scope.prototype.filteringRequestBody = function filteringRequestBody() {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.transformRequestBodyFunction) {
...
Scope.prototype.replyDate = function replyDate(d) {
  this.date = d || <span class="branch-1 cbranch-no" title="branch not covered" >new Date();</span>
  return this;
};
&nbsp;
&nbsp;
